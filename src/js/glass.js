...
window.onload = function () {
    ...
    var oShadow    = document.getElementById('shadow-s');
    ...
    oMiddleBox.addEventListener('mousemove', (event) => {
        ...
        var iL = e.pageX - oMiddleBox.offsetLeft - oShadow.offsetWidth / 2;
        var iT = e.pageY - oMiddleBox.offsetTop  - oShadow.offsetHeight / 2;
